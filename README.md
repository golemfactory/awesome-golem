...
- [EasyYagnaJS](https://github.com/figurestudios/easy-yagna-js) - Copies over NodeJS dependencies directly to the provider, making developers not have to use Docker in their workflow.
